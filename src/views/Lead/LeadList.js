...
class LeadList extends Component {
  ...
  render() {
    ...
    const apiClients = this.props.api_clients.filter(apiClient => apiClient.permissions.includes('view_api_client_leads'));
    ...
    const columns = [
      ...
      },
      {
        ...
        renderer: lead => lead.apiClient.name
      }
    ];
                ...
                <div className="card">
                  ...
                  <div className="card-block">
                    <div className="row entity-form-controls">
                      ...
                      <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <label htmlFor="api_clients">
                          <FormattedMessage id="sources" defaultMessage="Sources" />
                        </label>
                        <ApiFormChoiceField
                            name="api_clients"
                            id="sources"
                            ...
                            searchable={false}
                            onChange={this.state.apiFormFieldChangeHandler}
                            value={this.state.formValues.api_clients}
                            placeholder={messages.all_feminine}
                        />
                      </div>

            ...
            <main className="main">
              ...
              <div className="container-fluid main-content d-flex flex-column">
                <Switch>
                  ...
                  <DetailPermissionRoute key="4" exact path="/entities/:id" resource="entities" name="EntityDetail" requiredResources={['stores', 'product_types']} component={EntityDetail} redirectPath="/entities/" />
